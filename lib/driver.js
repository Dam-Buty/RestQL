module.exports = function(Promise, transport, ConnectionFactory) {
  return {
    transport: transport,
    connections: {},
    authorities: {},
    ...
    select: function(params) {
      ...
      if (this.authorities[params.table] !== undefined) {
        source = this.authorities[params.table];
      } else {
        source = this.fastest;
      }

      return source.select(params);
    }
  };
};
