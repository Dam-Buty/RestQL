    ...
    _selectFromCache: function(obj) {
      ...
      if (obj.params.id === undefined) {
        if (this.cache[obj.params.table]["__status"] === "complete") {
          resolved = JSON.parse(JSON.stringify(this.cache[obj.params.table]));
          delete resolved.__type;
          delete resolved.__status;
        }
      } else {
        if (this.cache[obj.params.table][obj.params.id] !== undefined) {
          resolved = this.cache[obj.params.table][obj.params.id];
        }
      }
